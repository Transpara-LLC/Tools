...
function replaceConnectionStrings {
    ...
    appendTextToRestoreScript('$global:remotecontextFolders = Get-ChildItem "$pathToTargetInstance\Remote Context Services"')
...
function packSystemFilesAndSite {
    ...
    appendTextToRestoreScript('$global:pathToTargetSite=Get-WebFilePath "iis:\Sites\$global:targetSiteName\"')
    appendTextToRestoreScript('copy $PSScriptRoot\$global:sourceInstanceName -Destination $global:pathToTargetSite\$global:targetInstanceName -Recurse -Force')
    appendTextToRestoreScript('$global:pathToTargetInstance=Get-WebFilePath "iis:\Sites\$global:targetSiteName\$global:targetInstanceName"')
    $ws="_WS" 
...
function getServerAndDB {
  ...
  foreach($line in $lines) {
    if($line.contains("connectionString=")) {
      ...
      appendTextToRestoreScript('$global:sourceSQLDBName="'+$global:sourceSQLDBName+'"')
    }
  }
}
function editDatabaseInterfacesURL { 
    ...
    appendTextToRestoreScript('$update = @"')
     ...
     $portvar = '$global:targetSitePort'
     $portChanging = "[URL] = REPLACE([URL], 'localhost:', 'localhost:$portvar')"
     $portPutting = "[URL] = REPLACE([URL], 'localhost', 'localhost:$portvar')"
     #appendTextToRestoreScript("if CHARINDEX('localhost:',[URL]) > 0 ")
     #appendTextToRestoreScript('begin')
     #appendTextToRestoreScript('REPLACE')
     #appendTextToRestoreScript('(REPLACE')
     #appendTextToRestoreScript('(REPLACE')
     #appendTextToRestoreScript('(REPLACE')
     #appendTextToRestoreScript('(REPLACE')
     ...
     #appendTextToRestoreScript('(REPLACE')
     #appendTextToRestoreScript('(REPLACE')
     #appendTextToRestoreScript("(REPLACE ([URL], '0', ''),")
     #appendTextToRestoreScript("'1', ''),")
     #appendTextToRestoreScript("'2', ''),")
     #appendTextToRestoreScript("'3', ''),")
     #appendTextToRestoreScript("'4', ''),")
     #appendTextToRestoreScript("'5', ''),")
     #appendTextToRestoreScript("'6', ''),")
     #appendTextToRestoreScript("'7', ''),")
     #appendTextToRestoreScript("'8', ''),")
     #appendTextToRestoreScript("'9', ''),")
     #appendTextToRestoreScript($portChanging)

     #appendTextToRestoreScript('end')
     #appendTextToRestoreScript('else')
     #appendTextToRestoreScript($portPutting)
...
appendTextToRestoreScript('function Use-RunAs {')    
    # Check if script is running as Adminstrator and if not use RunAs 
    # Use Check Switch to check if admin 
     
    appendTextToRestoreScript('param([Switch]$Check)') 
     
    appendTextToRestoreScript('$IsAdmin = ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()`') 
        appendTextToRestoreScript(').IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator")') 
         
    appendTextToRestoreScript('if ($Check) { return $IsAdmin }')     
 
    appendTextToRestoreScript('if ($MyInvocation.ScriptName -ne "")') 
    appendTextToRestoreScript('{')  
        appendTextToRestoreScript('if (-not $IsAdmin)')  
        appendTextToRestoreScript('{')  
            appendTextToRestoreScript('try') 
            appendTextToRestoreScript('{') 
                appendTextToRestoreScript('$arg = "-file `"$($MyInvocation.ScriptName)`""') 
                
                appendTextToRestoreScript('Start-Process "$psHome\powershell.exe" -Verb Runas -ArgumentList $arg -ErrorAction ''stop''')  
            appendTextToRestoreScript('}') 
            appendTextToRestoreScript('catch') 
            appendTextToRestoreScript('{') 
                appendTextToRestoreScript('Write-Warning "Error - Failed to restart script with runas"')  
                appendTextToRestoreScript('break')               
            appendTextToRestoreScript('}') 
             appendTextToRestoreScript('exit') # Quit this session of powershell 
        appendTextToRestoreScript('}')  
    appendTextToRestoreScript('}')  
    appendTextToRestoreScript('else')  
    appendTextToRestoreScript('{')  
        appendTextToRestoreScript('Write-Warning "Error - Script must be saved as a .ps1 file first"')  
        appendTextToRestoreScript('break')  
    appendTextToRestoreScript('}')  
appendTextToRestoreScript('}') 
appendTextToRestoreScript("Use-RunAs")  
...
appendTextToRestoreScript('$global:targetSitePort = Get-WebBinding -Name $global:targetSiteName | select bindingInformation')
appendTextToRestoreScript('$global:targetSitePort = $global:targetSitePort -replace "bindingInformation", ""')
appendTextToRestoreScript('$portPattern = ":([0-9]*):"')
appendTextToRestoreScript('$port = [regex]::Match($global:targetSitePort, $portPattern).captures.groups[1].value')
